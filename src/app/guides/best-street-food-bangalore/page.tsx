        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <section className="space-y-6 mb-12">
            {streetFoodSpots.map((spot, i) => (
              <div key={spot.name} className="bg-white rounded-xl p-6 border border-stone-200">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <span className="text-orange-600 font-semibold text-sm">#{i + 1}</span>
                    <h2 className="text-xl font-semibold text-stone-900">{spot.name}</h2>
                    <p className="text-stone-500 text-sm">{spot.area} • {spot.specialty}</p>
                  </div>
                </div>
                <p className="text-stone-700 mb-4">{spot.description}</p>
                ...
                <p className="text-sm text-stone-500">⏰ {spot.timing}</p>
              </div>
            ))}
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/guides/best-restaurants-bangalore" className="px-4 py-2 bg-stone-100 rounded-full text-stone-700 hover:bg-emerald-100 hover:text-emerald-700 transition-colors">
                Best Restaurants →
              </Link>
              <Link href="/guides/best-biryani-bangalore" className="px-4 py-2 bg-stone-100 rounded-full text-stone-700 hover:bg-emerald-100 hover:text-emerald-700 transition-colors">
                Best Biryani →
              </Link>
            </div>
          </section>
